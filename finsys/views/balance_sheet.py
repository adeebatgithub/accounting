...
class BalanceSheetView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        fixed_entries = models.FixedAssetsHistoryModel.objects.filter(is_deleted=False).values("from_where").annotate(total_amount=Sum("current_balance")).order_by("from_where")
